...
import type { LayoutMode, PlacedChip, Stats } from '../game/types'
...
export function EndScreen({ stats, remaining, mistakes, board, layout, germOrder, familyOrder, onHome }: Props) {
  ...
  return (
    <div className="app end-boardview" data-layout={layout}>
      <div className="end-boardbar">
        <span className="end-boardbar-title">Your final board</span>
        {!summaryOpen && (
      ...
      <main className="playfield">
        <Grid board={board} feedback={null} germOrder={germOrder} familyOrder={familyOrder} />
      </main>
        ...
        <div className="end-modal-backdrop">
          <div className="end-card">
            ...
            <div className="end-actions">
              <button className="btn btn--ghost" onClick={() => setSummaryOpen(false)}>
                View final board
              </button>
